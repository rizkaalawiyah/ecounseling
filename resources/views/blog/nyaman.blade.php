                    ...
                    <form action="{{ route('blog.upload') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ !$errors->has('file') ?: 'has-error' }}">
                          ...
                          @endif
                            ...
                            <h5 class="card-title ">Paket Nyaman</h5>
                            <h6 class="card-title pb">TOTAL Rp350.000</h6>
                            <p class="card-text pb">Anda akan dikenakan biaya Rp350.000 untuk 4x sesi konseling dalam waktu 1 bulan dengan garansi uang kembali (syarat dan ketentuan berlaku).</p>
