                    ...
                    <form action="{{ route('blog.upload') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ !$errors->has('file') ?: 'has-error' }}">
                          ...
                          @endif
                            ...
                            <h5 class="card-title pb-3">Paket Perkenalan</h5>
                            <h6 class="card-title pb-3">TOTAL Rp100.000</h6>
                            <p class="card-text pb-3">Anda akan dikenakan biaya Rp100.000 untuk 1x sesi konseling yang berlaku 1 minggu.</p>
