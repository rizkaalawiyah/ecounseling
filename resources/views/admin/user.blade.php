...
<body>
 ...
 <div class="sidebar">
  ...
  <a href="{{ url('admin/user') }}"><button class="btn"><i style="margin-right: 5px" class="fa fa-lock"></i></button><br></a>
  <a href="{{ url('admin/user') }}"><button class="btnn"><i style="margin-right: 5px" class="fa fa-user"></i></button><br></a>
 </div>
 <div class="wrapper">
