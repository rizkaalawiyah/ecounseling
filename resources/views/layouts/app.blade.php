...
<body>
    <div id="app">
        <v-toolbar fixed color="white">
                  <a class="navbar-brand" href="{{ url('blog/home') }}"><img class="logo" src="{{ url('img/logo.png') }}" style="width: 70px; height: 70px;"></a>
            <v-toolbar-title> E-Counseling ChatBox</v-toolbar-title>
            <v-spacer></v-spacer>
